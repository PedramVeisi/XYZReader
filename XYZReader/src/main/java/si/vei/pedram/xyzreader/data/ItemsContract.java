package si.vei.pedram.xyzreader.data;

import android.net.Uri;

public class ItemsContract {
	public static final String CONTENT_AUTHORITY = "si.vei.pedram.xyzreader";
	public static final Uri BASE_URI = Uri.parse("content://si.vei.pedram.xyzreader");
	...
	public static class Items implements ItemsColumns {
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.si.vei.pedram.xyzreader.items";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.si.vei.pedram.xyzreader.items";
